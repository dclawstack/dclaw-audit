...
**DClaw Audit** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8037` (FastAPI)
- **Frontend Port:** `3037` (Next.js)
- **Database:** `dclaw_audit` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3037`
