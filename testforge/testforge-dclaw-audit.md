# TestForge Report — /work/project/dclaw-audit

**Overall:** 69/100  ·  7771 files · 1,128,631 lines · 135 endpoints
**Stack:** FastAPI, SQLAlchemy, Pydantic, Alembic, pytest, HTTP client (httpx/requests), PostgreSQL, Uvicorn/Gunicorn
**Analyzed:** 2026-05-31T12:41:30.980Z
...
| Edge Cases | 67/100 | 0 |
| Contract | 98/100 | 0 |
| Predictive Risk | 69/100 | 0 |
| N+1 Queries | 83/100 | 0 |
| Dead Code | 57/100 | 0 |
| Load | N/A | 0 |
| Chaos | 100/100 | 0 |
| Agentic Scale | 91/100 | 1 |
| Accessibility | 61/100 | 0 |
| Visual Regression | 96/100 | 0 |
| Vision | 81/100 | 3 |
| Scope | 100/100 | 0 |
| Stack | 47/100 | 0 |
| DORA | 25/100 | 0 |
...
554 total · 317 critical · 227 high · 1 medium · 3 low
- **[HIGH]** XSS via `write()` helper — `web/node_modules/object-hash/index.js:221`
  - _Fix:_ Either sanitize the argument before passing it to `write`, or rewrite `write` to use the safe alternative (parameterized queries, escape, etc.) internally.
- **[HIGH]** XSS via `write()` helper — `web/node_modules/object-hash/index.js:245`
  - _Fix:_ Either sanitize the argument before passing it to `write`, or rewrite `write` to use the safe alternative (parameterized queries, escape, etc.) internally.
...
Model: anthropic/claude-sonnet-4.6 · 14/14 tests passed
- `no-observability-stack-detected-src-l0.test.ts` — passed 6/6 · for: No observability stack detected
- `no-product-analytics-dependency-src-l0.test.ts` — passed 5/5 · for: No product analytics dependency
