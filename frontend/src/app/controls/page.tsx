...
import {
  ...
  CreateFrameworkRequirementPayload,
  FrameworkName,
...
export default function ControlsPage() {
  ...
  const [reqForm, setReqForm] = useState<CreateFrameworkRequirementPayload>({
    framework: "sox",
    requirement_code: "",
    title: "",
    description: "",
  });
  const [mappingForm, setMappingForm] = useState<CreateControlMappingPayload>({
    control_id: "",
