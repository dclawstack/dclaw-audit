...
[![Status](https://img.shields.io/badge/status-P4%20Planned-475569)](https://github.com/dclawstack/dclaw-audit)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/audit)

---

## Overview

DClaw Audit is an AI-native governance application. It follows the standard DClaw architecture:
...
DClaw Audit uses the **DKube Design System** with its app-specific brand color.
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_audit"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-audit.git /opt/dclaw-audit
cd /opt/dclaw-audit
docker compose up -d
```

The app will be available at `https://audit.dclawstack.io`.
...
helm upgrade --install dclaw-audit . \
...
- [Docs](https://docs.dclawstack.io/apps/audit)
